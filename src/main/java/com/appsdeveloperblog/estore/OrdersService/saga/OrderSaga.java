...
//		xstream.allowTypeHierarchy(Collection.class);
		...
		// xstream.allowTypesByWildcard(new String[] { "com.appsdeveloperblog.estore.core.**" });
	//}
	...
	public void handle(ProductReservedEvent productReservedEvent) {
		...
		scheduleId = deadlineManager.schedule(Duration.of(120, ChronoUnit.SECONDS), PAYMENT_PROCESSING_TIMEOUT_DEADLINE,
